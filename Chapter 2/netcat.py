...
parser = argparse.ArgumentParser(
    description='BHP Net Tool, Written by Zayed Al Teneiji | netrunner',
...
parser.add_argument('-t', '--target', default='192.1.1.203', help='Specified IP')
